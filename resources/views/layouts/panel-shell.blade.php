    ...
    <body class="font-hub antialiased text-slate-100">
        ...
        >
            ...
            <div class="flex min-h-screen">
                <aside
                    id="sidebarElement"
                    class="hub-sidebar fixed inset-y-0 left-0 z-50 w-[min(100%,17.5rem)] transform transition-transform duration-200 ease-out lg:static lg:z-0 lg:w-64 lg:translate-x-0 lg:shrink-0 -translate-x-full"
